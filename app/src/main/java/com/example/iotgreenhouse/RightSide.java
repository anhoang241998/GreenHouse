...
public class RightSide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_right_side);
        ...
        mAuto.setOnClickListener(v -> {
            ...
            Toast.makeText(RightSide.this, "Auto", Toast.LENGTH_SHORT).show();
            mAuto.setBackgroundColor(getResources().getColor(R.color.green));
            mManual.setBackgroundColor(getResources().getColor(R.color.purple_500));
        ...
        mManual.setOnClickListener(v -> {
            ...
            Toast.makeText(RightSide.this, "Manual", Toast.LENGTH_SHORT).show();
            mManual.setBackgroundColor(getResources().getColor(R.color.green));
            mAuto.setBackgroundColor(getResources().getColor(R.color.purple_500));

            mFanOn.setClickable(true);
            mFanOn.setFocusable(true);
            mFanOn.setFocusableInTouchMode(true);

            mFanOff.setClickable(true);
            mFanOff.setFocusable(true);
            mFanOff.setFocusableInTouchMode(true);

            mPumpOn.setClickable(true);
            mPumpOn.setFocusable(true);
            mPumpOn.setFocusableInTouchMode(true);

            mPumpOff.setClickable(true);
            mPumpOff.setFocusable(true);
            mPumpOff.setFocusableInTouchMode(true);
        });

        mFanOn.setOnClickListener(v -> {
            mFanReference.setValue(1);
            Toast.makeText(RightSide.this, "Fan On", Toast.LENGTH_SHORT).show();
            mFanOn.setBackgroundColor(getResources().getColor(R.color.green));
            mFanOff.setBackgroundColor(getResources().getColor(R.color.purple_500));
        });

        mFanOff.setOnClickListener(v -> {
            mFanReference.setValue(0);
            Toast.makeText(RightSide.this, "Fan Off", Toast.LENGTH_SHORT).show();
            mFanOff.setBackgroundColor(getResources().getColor(R.color.green));
            mFanOn.setBackgroundColor(getResources().getColor(R.color.purple_500));
        });

        mPumpOn.setOnClickListener(v -> {
            mPumpReference.setValue(1);
            Toast.makeText(RightSide.this, "Pump On", Toast.LENGTH_SHORT).show();
            mPumpOn.setBackgroundColor(getResources().getColor(R.color.green));
        ...
        mPumpOff.setOnClickListener(v -> {
            ...
            Toast.makeText(RightSide.this, "Pump Off", Toast.LENGTH_SHORT).show();
            mPumpOff.setBackgroundColor(getResources().getColor(R.color.green));
            mPumpOn.setBackgroundColor(getResources().getColor(R.color.purple_500));
        });

        mAutoReference.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mManualReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if (snapshot.getValue() != null) {
                    String value = snapshot.getValue() + "";
        ...
        mPumpReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if (snapshot.getValue() != null) {
                    String value = snapshot.getValue() + "";
